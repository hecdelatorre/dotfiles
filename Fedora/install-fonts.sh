...
echo -e "\n Install Fonts\n"
sudo dnf in adobe-source-code-pro-fonts cascadia-code-fonts fira-code-fonts google-roboto* google-rubik-fonts mozilla-fira* ibm-plex* jetbrains-mono-fonts-all -y
