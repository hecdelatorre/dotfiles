...
curl -fsSLo .theme.vimrc https://gitlab.com/hecdelatorre/dotfiles/-/raw/main/Neovim/Themes/onehalfdark/theme.vimrc
curl -fsSLo .vimrc_tem https://gitlab.com/hecdelatorre/dotfiles/-/raw/main/Neovim/Themes/onehalfdark/.vimrc
